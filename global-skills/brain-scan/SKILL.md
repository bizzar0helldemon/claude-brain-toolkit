...
- **Project notes:** `{{SET_YOUR_BRAIN_PATH}}/projects/[category]/[slug].md`
- **Project index:** `{{SET_YOUR_BRAIN_PATH}}/projects/_INDEX.md`
- **Raw archive:** `{{SET_YOUR_BRAIN_PATH}}/archive/raw-claude-mds/[category]/`
- **Templates:** `{{SET_YOUR_BRAIN_PATH}}/brain-scan-templates.md`

All vault destination paths below are relative to the brain root above. The *scan path* (`$ARGUMENTS`) is the external project directory being cataloged and is read-only.
