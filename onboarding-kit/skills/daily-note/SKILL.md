...
Log entries into the Claude Brain vault at `{{BRAIN_PATH}}/daily_notes/`.
...
3. **Create or append** to `{{BRAIN_PATH}}/daily_notes/YYYY-MM-DD.md`
...
- Reference projects by name: `[[Project Name]]`
- Reference people: `[[Group Name]]`, collaborator names
...
> [!idea] Could reuse the cache system for the analytics pipeline
> Same invalidation logic, different data source.
...
```yaml
tags: [project/myproject, decision, insight]
```
